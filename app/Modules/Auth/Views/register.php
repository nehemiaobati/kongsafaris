    ...
    <div class="col-md-6">
        <div class="card blueprint-card p-4">
            ...
            <form action="<?= url_to('auth.register.submit') ?>" method="POST" autocomplete="off">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        <div class="form-floating">
                            <input type="text" class="form-control bg-dark border-secondary text-light" id="firstNameInput" name="first_name" placeholder="First Name" value="<?= old('first_name') ?>" required>
                            <label for="firstNameInput" class="text-secondary">First Name</label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-floating">
                            <input type="text" class="form-control bg-dark border-secondary text-light" id="lastNameInput" name="last_name" placeholder="Last Name" value="<?= old('last_name') ?>" required>
                ...
                <div class="form-floating mt-3">
                    <input type="password" class="form-control bg-dark border-secondary text-light" id="passwordInput" name="password" placeholder="Password" required minlength="6">
