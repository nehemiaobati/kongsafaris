                ...
                <div class="row g-2 mb-3">
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="vehicleSelect">Vehicle Class</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="driverSelect">Assigned Driver</label>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                ...
                <div class="mb-3">
                    <span class="text-muted small">Total Booking cost:</span>
                    <h3 class="fw-bold text-accent mt-1" id="modalTotal">Ksh 0.00</h3>
                </div>
...
<script>
        ...
        function resolvePinnedAddress(lat, lng) {
            ...
            return fetch("<?= url_to('trips.geocode.reverse') ?>", {
                ...
                .then(data => {
                    ...
                    return data.status === "success" && data.result.address ? data.result.address : null;
                })
                .catch(() => null);
        }
    ...
    document.getElementById("bookBtn").addEventListener("click", function() {
        document.getElementById("modalTotal").innerText = document.getElementById("summaryTotal").innerText;
